     ...
     {/*------Left----------- */}
      <div className="flex flex-col items-center gap-3">
        <img 
          ...
          alt="logo" 
          className="w-[min(10vw,250px)]"
        />
        <h1 className="text-3xl font-bold text-white">ChitChat</h1>
        <p className="text-gray-300">Connect. Chat. Share.</p>
      </div>
     {/*-------Right------------ */}

    <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-10 flex
     flex-col gap-2 rounded-lg shadow-lg'>
